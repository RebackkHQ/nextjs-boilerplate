...
/**
 * Clone React element.
 * The function clones React element and adds CSS classnames to the element
...
export function cloneElement(element: React.ReactElement, classNames: string) {
	return React.cloneElement(element, { className: twMerge(element.props.className, classNames), });
}
